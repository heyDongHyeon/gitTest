        ...
        <tr>
            ...
            <td>
                <select id="key" name="" class="sendData">
                    ...
                    <option value="7">지역 별 AWS</option>
                    <option value="5">지역 별 강우량</option>
                    <option value="9">동네예보 강수확률</option>
                </select>
            </td>
        </tr>
        <tr>
...
<% } %>
       ...
       <tr>
            <th>일자</th>
            <td>
                <input type="text" id="dat" name="objName" class="sendData date" style="width:100%; margin:1px; padding:0px;" value="">
            </td>
        </tr>
        <!-- <tr>
