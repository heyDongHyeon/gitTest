...
public class CctvMapService extends EgovAbstractServiceImpl {
    ...
    public String getSymbolGroupAsJSON(CctvSymCmd cmd) throws Exception{
        List<CctvSymGrpVO> cctvs = getSymbolGroup(cmd);
    ...
    public List<CctvSymGrpVO> getSymbolGroup(CctvSymCmd cmd) throws Exception {
        ...
        List<CctvSymVO> dbLists = cctvMapServiceMapper.selectExtent(extent, cmd.getCodes());
