...
<div id="xeus-map-content-ndps" class="map-target">
...
<div id="xeus-overview-ndpsView" class="overview"></div>
<div id="fav-wrap">
   <div id="fav-header">
...
<div id="overlay-west-side-bar" class="overlay-side-bar">
 ...
 <!--    <button id="btn-nmg-monitor-view" class="menu-button" for="btn-nms-mng" icon="menu8">상태<br>모니터링</button> -->
    <button id="btn-ndps-aws-view" class="menu-button" for="btn-ndps-mng" icon="menu25">AWS</button>
    <button id="btn-ndps-rain-view" class="menu-button" for="btn-ndps-mng" icon="menu25">강우계</button>
    <button id="btn-ndps-snow-view" class="menu-button" for="btn-ndps-mng" icon="menu25">적설계</button>
    <button id="btn-ndps-dim-view" class="menu-button" for="btn-ndps-mng" icon="menu25">수위계</button>
</div>
