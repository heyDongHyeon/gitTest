...
ArrayList<IfEvtLogVo> list = (ArrayList<IfEvtLogVo>) request.getAttribute("list");
...
<body>
           ...
           <table>
                <thead>
                    <tr align = "center">
                       <td colspan="9" align="center">이벤트로그현황</td>
                    </tr>
                    <tr align="center">
                        <td colspan="6"></td>
