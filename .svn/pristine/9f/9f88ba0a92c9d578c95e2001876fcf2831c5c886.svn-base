...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <!-- 대시보드 -->
    <button id="btn-event-stat-view" class="menu-button" for="btn-stat-view">이벤트 통계</button>
    <button id="btn-ndms-stat-view" class="menu-button" for="btn-stat-view">NDMS<br>통계</button>
    <button id="btn-ndps-stat-view" class="menu-button" for="btn-stat-view">재난시설물<br>통계</button>
