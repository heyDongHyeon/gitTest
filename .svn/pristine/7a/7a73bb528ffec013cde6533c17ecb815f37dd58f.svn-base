...
public interface SearchMapper{
    ...
    public HashMap<String, String> getEmdPosi(HashMap<String, String> map);

    public HashMap<String, String> getLiPosi(HashMap<String, String> map);

    public HashMap<String, String> getSigPosi(HashMap<String, String> map);

    public List<EmdVo> getEmdList();
    
    public List<HashMap<String, String>> getDamnmList();
