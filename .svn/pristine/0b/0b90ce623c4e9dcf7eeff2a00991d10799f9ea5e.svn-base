...
<div>
    ...
    <div id="wrap">
        ...
        <div id="title" url="/log/getStillCutLogView.do" excel = "StillCut">CCTV 스틸컷 로그</div>
        <div id="search">
            <input id="userId" class="keyup sendData" type="text" value="" placeholder="사용자 ID">
...
for(int i=0; i<column.size(); i++){
    if(column.get(i).getTblId().equals("xeus.mon_stillcut_log")){
%>
