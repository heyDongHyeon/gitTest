...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <!-- 영상반출 관리 -->
    <button id="btn-tvius-rqst-view" class="menu-button" for="btn-tvus-mng" icon="menu13">영상정보<br>신청현황</button>
    <button id="btn-tvius-ext-view" class="menu-button" for="btn-tvus-mng" icon="menu14">연장신청<br>현황</button>
    <button id="btn-tvius-evi-view" class="menu-button" for="btn-tvus-mng" icon="menu15">증거신청<br>현황</button>
    <button id="btn-tvius-exp-view" class="menu-button" for="btn-tvus-mng" icon="menu23">재생만료<br>현황</button>
    <button id="btn-tvius-img-mng-view" class="menu-button" for="btn-tvus-mng">화면캡처<br>반출현황</button>
    <button id="btn-tvius-mng-reg-view" class="menu-button" for="btn-tvus-mng" icon="menu27">관리대장</button>
    <button id="btn-tvius-stat-view" class="menu-button" for="btn-tvus-mng" icon="menu24">통계</button>
    <button id="btn-tvius-urg-reg" class="menu-button" for="btn-tvus-mng">긴급반출</button>
    <button id="btn-tvius-hash-chk" class="menu-button" for="btn-tvus-mng">해시코드<br>조회</button>
    <button id="btn-tvius-heat-view" class="menu-button" for="btn-tvus-mng">히트맵</button>
</div>
