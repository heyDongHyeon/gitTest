...
<div id="xeus-overview-nmsView" class="overview"></div>
<div id="fav-wrap">
   <div id="fav-header">
...
<div id="overlay-west-side-bar" class="overlay-side-bar">
 ...
 <!--    <button id="btn-nmg-monitor-view" class="menu-button" for="btn-nms-mng" icon="menu8">상태<br>모니터링</button> -->
    ...
    <button id="btn-infra-view" class="menu-button" for="btn-nms-mng" icon="menu25">장비 관리</button>
...
<!--     <button id="btn-nms-view" class="menu-button" for="btn-nms-mng">논리망조회<br>NMS</button>
    <button id="btn-cable-view" class="menu-button" for="btn-nms-mng">케이블관리<br>FNMS</button>
    <button id="btn-parking-mng" class="menu-button" for="btn-nms-mng" icon="menu6">구청주차<br>현황</button> -->
</div>
