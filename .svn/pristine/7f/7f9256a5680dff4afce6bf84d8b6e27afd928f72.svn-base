...
public class IpInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		...
		for(int i=0; i<list.size(); i++){
			...
			/*if(userIp != null && !"".equals(userIp)) System.out.println(this.ipToLong(userIp));
			if(startIp != null && !"".equals(startIp)) System.out.println(this.ipToLong(startIp));
			if(endIp != null && !"".equals(endIp)) System.out.println(this.ipToLong(endIp));*/
			if(isAllow) break;
		}
