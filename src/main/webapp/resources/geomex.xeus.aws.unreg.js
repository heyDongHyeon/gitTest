...
//
	...
	$("#" + parentView).find("#backBtn").click(function(){
		...
		_common.callAjax("/aws/getAwsMngView.do", null, function(view) {
...
//		console.log("mgr3[1] = "+mgr3[1]);
		...
		param["tmLat"]=lat;
		param["tmLon"]=lng;
		console.log("tel3 = " +param["mgrTel3"]);
		console.log("phone3 = " +param["mgrPhone3"]);
...
//	    }
		confirm("신규추가 하시겠습니까?", function(){
			_common.callAjax("/aws/add.json", param, function(json) {
				if(json.result){
					alert("저장되었습니다.");
