...
%>
<script type="text/javascript" src="<%= context %>/res/geomex.xeus.voice.unreg.js"></script>
<div id="overlay-east-bar" class="overlay-bar">
    <b class="overlay-bar-title">방송장비 신규등록</b>
...
<div id="overlay-east-contents" style="background: rgb(59, 59, 59);" class="ui-droppable">
	...
	<table id="regTable" class="list" cellspacing="0">
		<tr>
			<th>문서관리번호</th>
			<td colspan="3">
				<input type="text" id="docMgrNo" name="conPwd" class="sendData wide" placeholder="세종특별자치시-부강면-음성통보-01" style="color: rgb(255, 255, 255);" value="">
			</td>
		</tr>
		<tr>
			<th>시설구분</th>
            <td colspan="3">
                <input type="text" id="fclGbnNm" name="cctvNm" class="sendData wide" placeholder="음성통보시스템  -수신단말기(03622), 디지털앰프, 스피커4EA" style="color: rgb(255, 255, 255);" value="">
            </td>
		</tr>
		<tr>
			<th>지구명</th>
			  <td colspan="3">
                <input type="text" id="locNm" name="cctvNm" class="sendData wide" placeholder="조천교" style="color: rgb(255, 255, 255);" value="">
            </td>
		</tr>
		<tr>
			<th>주소</th>
		...
		<tr>
			...
			<th>통신방식</th>
			<td>
				<input type="text" id="commMtd" name="portNum" class="sendData wide" placeholder="CDMA 무선통신(300-3400HZ) / 010-9127-2916" style="color: rgb(255, 255, 255);" value="">
			</td>
		</tr>
		<tr>
			<th>위도</th>
			<td>
				<input type="text" id="lat" name="lng" class="sendData wide loc" style="color: rgb(255, 255, 255);" value="">
			</td>
			<th>경도</th>
			<td>
				<input type="text" id="lng" name="lat" class="sendData wide loc" style="color: rgb(255, 255, 255);" value="">
			</td>
		</tr>
		<tr>
			<th>소속</th>
...
%>
	<tr>
		...
		<td align="center">
			...
			<input type="text" id="mgrPhone<%=i%>" name="lat" class="sendData wide" placeholder="000-0000-0000" style="color: rgb(255, 255, 255); text-align:center;" value="">
		</td>
	</tr>
<%
	}
