...
/* 이미지 삭제 이벤트 입니다. */
$(".imgBox").find(".close").click(function(){
...
/* 지도에서 위치설정 이벤트 입니다. */
$(".searchWrapper").find("#mapClickBtn").click(function(){
    $("body").css("cursor", "crosshair");
    $(".selectCancel").show(500);
...
$(".searchWrapper").find(".selectCancel").click(function(){
    Public.StopEvent();
});

/* 사진 추가 버튼 이벤트 입니다. */
$(".searchWrapper").find("#uploadBtn").click(function(){
...
/* 내용 저장 버튼 이벤트 입니다. */
$(".searchWrapper").find("#editBtn").click(function(){
