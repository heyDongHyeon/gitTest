...
$("#" + parentView).find("#newInfra").click(function(){
	...
	_common.callAjax("/nms/getInfraMngView.do", null, function(view) {
		$("#" + parentView).find("#center-overlay-east").html(view);
...
<div id="overlay-east-bar" class="overlay-bar">
    <b class="overlay-bar-title">시설 신규추가</b>
    ...
    <button class="blueBtn" id="backBtn" style="width: 96px;">뒤로가기</button>
</div>
