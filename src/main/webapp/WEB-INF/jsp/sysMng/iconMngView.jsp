...
//System.out.println(iconJson.toString());
...
function resizeDone() {
	$('#'+parentView).find("#content").css('height', $(window).height()-$('#layout-north').height()-$('#overlay-west-bar').height()-200);
}
...
$(".btn-del").click(function(){
	...
	confirm("해당 아이콘을 삭제하시겠습니까?", function(){
...
<title>아이콘 관리 | XEUS-Platform</title>
</head>
<body>
<div>
...
%>
	        ...
	        <button class="stat_btn" id="btn-upload" style="margin-left:5px;">파일첨부</button>
        ...
        <div id="content" style="max-height: none !important;">
...
%>
                <tr>
                	...
                	<td><button class="grayBtn btn-del" mgrno="<%= list.get(i).getMgrNo() %>" style="height: 25px; margin:3px 0px 0px 3px;">삭제</button></td>
                </tr>
<%
    	}
    }
