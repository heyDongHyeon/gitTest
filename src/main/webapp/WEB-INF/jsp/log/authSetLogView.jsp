...
<div>
    ...
    <div id="wrap">
        ...
        <div id="title"  url="/log/getAuthSetLogView.do">권한 설정 로그</div>
        <div id="search">
            <input id="usrId" class="keyup sendData" type="text" value="" placeholder="사용자 ID">
...
for(int i=0; i<column.size(); i++){
    if(column.get(i).getTblId().equals("xeus.mt_auth_log")){
%>
