...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <!-- 시스템 관리 -->
    <button id="btn-basic-mng" class="menu-button" for="btn-sys-mng">기본관리</button>
    ...
    <button id="btn-icon-mng" class="menu-button" for="btn-sys-mng">아이콘관리</button>
<!--     <button id="btn-equip-mng" class="menu-button" for="btn-sys-mng">장비관리</button> -->
  ...
  <!--   <button id="btn-evt-mng" class="menu-button" for="btn-sys-mng">이벤트관리</button> -->
    <button id="btn-log-view" class="menu-button" for="btn-sys-mng" icon="menu18">이력 조회</button>
    <!-- <button id="btn-sms-view" class="menu-button" for="btn-sys-mng">SMS 연동<br>테스트</button> -->
    <button id="btn-env-set" class="menu-button" for="btn-sys-mng">설정</button>
</div>
