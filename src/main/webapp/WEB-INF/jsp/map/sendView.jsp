...
<!-- 지도 div -->
<div id="xeus-map-content-send" class="map-target">
...
<div id="xeus-overview-sendView" class="overview"></div>
<div id="fav-wrap">
   <div id="fav-header">
...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <button id="btn-send-sms-view" class="send-menu menu-button" for="btn-send-view" icon="menu25">SMS 발송</button>
    <button id="btn-send-voice-view" class="send-menu menu-button" for="btn-send-view" icon="menu25">음성 발송</button>
    <button id="btn-send-disboard-view" class="send-menu menu-button" for="btn-send-view" icon="menu25">재난 전광판</button>
    <button id="btn-send-sendhist-view" class="send-menu menu-button" for="btn-send-view" icon="menu25">이력 조회</button>
</div>
