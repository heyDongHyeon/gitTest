...
<!-- 지도 div -->
<div id="xeus-map-content-ndms" class="map-target">

    <div id="popup"></div>
     <div class="show_event_form"><table></table></div>
...
<div id="xeus-overview-ndmsView" class="overview"></div>
<div id="fav-wrap">
   <div id="fav-header">
...
<div id="overlay-west-side-bar" class="overlay-side-bar">
    <button id="btn-ndms-119-view" class="ndms-menu menu-button"  for="btn-ndms-view" icon="menu25">긴급구조</button>
	<button id="btn-ndms-weather-view" class="ndms-menu menu-button" for="btn-ndms-view" icon="menu25">기상 정보</button>
    <button id="btn-ndms-wlevel-view" class="ndms-menu menu-button" for="btn-ndms-view" icon="menu25">수위정보</button>
    <button id="btn-ndms-inform-view" class="ndms-menu menu-button" for="btn-ndms-view" icon="menu25">통보문</button>

    <!-- <button id="btn-ndms-dfs-view" class="menu-button" for="btn-ndms-view" icon="menu25">동네예보</button>
    <button id="btn-ndms-pornqt-view" class="menu-button" for="btn-ndms-view" icon="menu25">강우량 정보</button>
    <button id="btn-ndms-powlvl-view" class="menu-button" for="btn-ndms-view" icon="menu25">수위 정보</button>
    <button id="btn-ndms-hrf-view" class="menu-button" for="btn-ndms-view" icon="menu25">댐 수위 정보</button>
    <button id="btn-ndms-inform-view" class="menu-button" for="btn-ndms-view" icon="menu25">기상 통보</button>
    <button id="btn-ndms-pre-view" class="menu-button" for="btn-ndms-view" icon="menu25">예비특보<br>통보</button>
    <button id="btn-ndms-earth-view" class="menu-button" for="btn-ndms-view" icon="menu25">지진 통보</button> -->
</div>
