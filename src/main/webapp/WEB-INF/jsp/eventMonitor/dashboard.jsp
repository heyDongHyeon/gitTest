...
<div id="overlay-west-contents" class="mCustomScrollbar" data-mcs-theme="minimal-dark">
	<div id="viewWrapper">
		<div class="widgets">
			...
			<div id="widget-evtList" class="widget">
				...
				<div class="widget-content">
					<div id="listWrap" class="mCustomScrollbar" data-mcs-theme="minimal-dark" style="height: 185px;">
