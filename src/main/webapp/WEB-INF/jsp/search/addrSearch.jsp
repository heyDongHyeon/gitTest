    ...
    <div id="searchWrap">
	    <table id="jibunUI">
	        <tr>
	            ...
	            <td colspan="2" class="lastTd"><button id="jibunSearch" class="jibunSearch searchBtn">검색</button></td>
	        </tr>
	    </table>
	    ...
	    <table id="doroUI" class="hidden">
	        ...
	        <tr>
	            <td colspan="2" class="lastTd"><button id="doroSearch" class="doroSearch searchBtn">검색</button></td>
	        </tr>
	    </table>
    </div>
</div>
