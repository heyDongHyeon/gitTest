...
_common.callAjax("/sysMng/getBasicTopMenuView.do", {'gbn': gbn}, function(view) {
    ...
    <div id="wrap">
        ...
        <div id="search">
            <input id="searchInput" class="keyup" for="#searchBtn" type="text" value="<%= searchStr %>" placeholder="코드명"><button id="searchBtn" class="stat_btn">검색</button>
...
for(int i=0; i<column.size(); i++){
	if(column.get(i).getTblId().equals("xeus.mt_cmm_cde")){
%>
...
%>
                    <tr>
                        ...
                        <td><button class="mngBtn" grp="<%= list.get(i).getGrpCde() %>" k="<%= list.get(i).getCdeCde() %>"></button></td>
                    </tr>
<%
    }
}
