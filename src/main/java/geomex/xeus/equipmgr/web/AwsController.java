...
//        	System.out.println("result = "+resultObj);
    ...
    public void add(Model model, HttpSession session, @ModelAttribute @Valid AwsVo param, BindingResult br)
    		throws Exception {
...
//        		System.out.println("result = "+resultBol);
    ...
    public void edit(Model model, HttpSession session, @ModelAttribute @Valid AwsVo param, BindingResult br) throws Exception {
...
//    			System.out.println("result = "+resultBol);
    ...
    public void del(Model model, @RequestParam HashMap<String, Object> param) throws Exception {
...
//			System.out.println("result = "+resultBol);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/getAwsMngView.do")
...
//			System.out.println("img = "+img);
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/getUnregAwsView.do")
