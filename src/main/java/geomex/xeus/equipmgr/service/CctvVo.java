...
public class CctvVo {
	...
	@Size(min=0, max=100, message="CCTV명은 최대100자 까지 입력하실 수 있습니다.")
...
*/
	...
	/**
	 * 
	 * 해당 mgrNo에 대한 관리자 데이터를 string으로 가져온다.
	 *
	 */
	...
	public String toString() {
		return "CctvVo [mgrNo="
			+ mgrNo + ", orgMgrNo=" + orgMgrNo +", strMgr=" + strMgr +", mgr=" +mgr+ ", mdMgrNo=" + mdMgrNo + ", siteMgrNo=" + siteMgrNo + ", instDat="
			+ instDat + ", cctvNm=" + cctvNm + ", deviceId=" + deviceId + ", chnlNo=" + chnlNo + ", gbnCd=" + gbnCd
			+ ", ipAddr=" + ipAddr + ", portNum=" + portNum + ", useYn=" + useYn + ", panYn="
			+ panYn + ", lightYn=" + lightYn + ", infrdYn=" + infrdYn + ", tiltYn=" + tiltYn + ", zoomYn=" + zoomYn
			+ ", talkYn=" + talkYn + ", conId=" + conId + ", conPwd=" + conPwd + ", snmpStr=" + snmpStr + ", constYear="
