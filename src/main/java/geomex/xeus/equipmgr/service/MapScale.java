...
public class MapScale {
    ...
    protected double screenScaleFactor = 0;
    protected double fracScrScaleFactor = 0;

    protected double mapCenterX = 0.0; // 화면 중심좌표, 실좌표
    protected double mapCenterY = 0.0; // 화면 중심좌표, 실좌표
    ...
    public void init(Envelope env, int mapWidth, int mapHeight) {
        ...
        screenScaleFactor = (env.getWidth() > env.getHeight()) ?
            env.getWidth() / this.mapWidth : env.getHeight() / this.mapHeight;
